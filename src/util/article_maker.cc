                                          ...
                                          bool expandOptionalParts ) const
{
  ...
  result += "<script type=\"text/javascript\">"
            ...
            "d1.alt = '[-]'; d1.src = 'qrcx://localhost/icons/collapse_opt.svg'; for( i = 0; i < 1000; i++ ) { var d2=document.getElementById( optionalId + i ); if( !d2 ) break; d2.style.display='inline'; } }"
            "else { d1.alt = '[+]'; d1.src = 'qrcx://localhost/icons/expand_opt.svg'; for( i = 0; i < 1000; i++ ) { var d2=document.getElementById( optionalId + i ); if( !d2 ) break; d2.style.display='none'; } } };"
